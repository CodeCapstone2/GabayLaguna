...
import { FaMapMarkedAlt, FaUsers, FaShieldAlt, FaGlobe, FaArrowRight, FaStar } from 'react-icons/fa';
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 col-md-7 mb-5 mb-lg-0">
            <div className="hero-content text-white">
              ...
              {/* Subtitle */}
              <p className="lead mb-5 lh-base" style={{ 
                fontSize: '1.25rem',
                opacity: 0.95,
                lineHeight: 1.7
              }}>
                Connect with licensed local tour guides, explore breathtaking destinations, 
                and create unforgettable memories in the heart of the Philippines.
              </p>

              {/* Features List */}
              <div className="mb-5">
                <div className="d-flex align-items-center mb-3">
                  <div className="bg-white rounded-circle d-flex align-items-center justify-content-center me-3" style={{ width: '24px', height: '24px' }}>
                    <FaStar size={12} style={{ color: '#667eea' }} />
                  </div>
                  <span className="text-white-75">Licensed & Verified Tour Guides</span>
                </div>
                <div className="d-flex align-items-center mb-3">
                  <div className="bg-white rounded-circle d-flex align-items-center justify-content-center me-3" style={{ width: '24px', height: '24px' }}>
                    <FaShieldAlt size={12} style={{ color: '#667eea' }} />
                  </div>
                  <span className="text-white-75">Secure Booking & Payment System</span>
                </div>
                <div className="d-flex align-items-center">
                  <div className="bg-white rounded-circle d-flex align-items-center justify-content-center me-3" style={{ width: '24px', height: '24px' }}>
                    <FaGlobe size={12} style={{ color: '#667eea' }} />
                  </div>
                  <span className="text-white-75">Explore Laguna's Best Destinations</span>
                </div>
              </div>
              ...
              <div className="trust-indicators">
                <div className="d-flex align-items-center justify-content-center mb-2">
                  <div className="d-flex me-3">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <FaStar key={star} className="text-warning me-1" size={16} />
                    ))}
                  </div>
